        ...
        <div class="form-wrapper">
            ...
            <form action="/user/update" method="post">
                ...
                <div class="form-item">
                    ...
                    <input type="text" name="name" placeholder="テスト太郎" value="<?php echo htmlspecialchars((string) (($tmp = $_smarty_tpl->tpl_vars['data']->value->name ?? null)===null||$tmp==='' ? $_smarty_tpl->tpl_vars['data']->value['name'] ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>
">
                ...
                <div class="form-item">
                    ...
                    <input type="text" name="kana" placeholder="てすとたろう" value="<?php echo htmlspecialchars((string) (($tmp = $_smarty_tpl->tpl_vars['data']->value->kana ?? null)===null||$tmp==='' ? $_smarty_tpl->tpl_vars['data']->value['kana'] ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>
">
                ...
                <div class="form-item">
                    ...
                    <input type="email" name="email" placeholder="example@cin-group.co.jp" value="<?php echo htmlspecialchars((string) (($tmp = $_smarty_tpl->tpl_vars['data']->value->email ?? null)===null||$tmp==='' ? $_smarty_tpl->tpl_vars['data']->value['email'] ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>
">
